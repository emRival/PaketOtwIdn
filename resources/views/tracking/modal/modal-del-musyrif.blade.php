<div class="modal fade" id="modal-del-musyrif{{$row->id}}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('musyrif.destroy', $row->id) }}" method="POST">
                @csrf
                @method('DELETE')
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <p>Apakah Anda Yakin Akan Menghapus Data Barang <br><strong>{{$row->siswa->nama_siswa}}
                                <span class="badge bg-success">{{$row->nama_barang}}</span> ?</strong>
