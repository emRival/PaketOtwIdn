        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-2 row">
                    <div class="col-md-6">
                        <h6 class="text-white text-capitalize ps-3">Data Barang Diambil</h6>
                    </div>

                    <div class="col-md-6 mb-2">
                        <form method="get" action="{{route('cari.diambil')}}">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#modal-del-selesai{{$row->id}}"><i
                                            class="fa fa-trash"></i></button>
                                    @endif
                                    @include('tracking.modal.modal-del-selesai')
                                </td>
                            </tr>
                            @empty
                            <tr>
