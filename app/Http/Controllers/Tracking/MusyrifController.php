...
class MusyrifController extends Controller
{
    ...
    {  
        ...
        $barang = Barang::where('status', 'musyrif')->orderBy('id', 'desc')->paginate(10);
    ...
    public function search(Request $request)
    {
        ...
        $keyword = $request->cari;
        $barang = Barang::where('nama_penerima', 'like', "%" . $keyword . "%")->paginate(5);
        return view('tracking.musyrif', compact( 'barang'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $barang->update($input);
        Alert::info('Success', 'Data Paket Berhasil Di update');
        return redirect('/musyrif');
    }
